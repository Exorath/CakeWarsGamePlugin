 ...
 */
public class LobbyProtectionManager extends ProtectionListener implements ListeningManager {
    public LobbyProtectionManager() {
        super(new LobbyProtectionConfiguration());
    }
}
